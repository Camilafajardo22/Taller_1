...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país que al que representa un atleta");
	...
	/**
	 * Le pide al usuario el nombre del atleta cuyo pais se desea consultar. A continuación
	 * le muestra al usuario el país que representa el atleta.
	 */
	...
	private void ejecutarPaisPorAtleta()
	{
		...
		String AtletaDeInteres = input("Por favor ingrese el nombre del atleta cuyo país desea consultar: ");
		Pais PaisAtleta = calculadora.PaisPorAtleta(AtletaDeInteres);
		System.out.println("El pais que respresenta el atleta " + AtletaDeInteres + " es: " + PaisAtleta.darNombre());
	}	
